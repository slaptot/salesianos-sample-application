...
import es.salesianos.zaragoza.ciberhealth.CiberHealthFakeApplicationApp;
...
import es.salesianos.zaragoza.ciberhealth.service.AuditEventService;
...
@SpringBootTest(classes = CiberHealthFakeApplicationApp.class)
@Transactional
